...
module.exports = function() {
    ...
    var constants = {
        ...
        style: {
            ...
            css: {
                src: ['./bower_components/famous-angular/dist/famous-angular.css', './bower_components/bootstrap/dist/css/bootstrap.css', './bower_components/bootstrap/dist/css/bootstrap-theme.css', './bower_components/angular-material/angular-material.css'] // you can also add a specific src_appname
            }
        },
        ...
        serve: {
            ...
            localtunnel: false // true, false or 'myfirstfamoapp'
        },
        mocha: {
            libs: ['server/**/*.js'],
            tests: ['test/mocha/**/*.js'],
